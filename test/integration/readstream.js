...
var tests = [
	[
		...
		{ transactionId: 1, protocol: 2, length: 13, unit: 4, functionCode: 3, registers: 2, data: [ 10, 11 ] }
	],
	[
		"Splitted message",
		...
		new Buffer([ 0, 40 ]),
		{ transactionId: 5, protocol: 4, length: 15, unit: 4, functionCode: 3, registers: 3, data: [ 20, 30, 40 ] }
	],
	[
		"Unknown message",
